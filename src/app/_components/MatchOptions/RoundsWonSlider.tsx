...
const RoundsWon = (props: Props) => {
  ...
  if (!isFetchedRoundsWon || !isFetchedCurrentMatchId || !roundsWonSliderQuery)
    return null
  ...
  return (
    <div className="flex w-full items-center justify-between">
      <label>
        {roundsWonSliderQuery?.matchById?.teams?.[index]?.name}&apos;s Score
      </label>
